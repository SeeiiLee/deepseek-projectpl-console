window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region \0dsh-css:D:\Deepseek Harness Personal\plugins\project-control\src\client\CandidateDetails.module.css.mjs
		const css$2 = ".wtQdrW_details{min-width:0;min-height:100%;color:var(--dsw-alias-label-primary);flex-direction:column;display:flex}.wtQdrW_header{border-bottom:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 5%, transparent);padding:18px 18px 14px}.wtQdrW_headerRow,.wtQdrW_statusLine,.wtQdrW_sectionHeading,.wtQdrW_documentHeading,.wtQdrW_documentMeta,.wtQdrW_issueList div{align-items:center;display:flex}.wtQdrW_headerRow,.wtQdrW_sectionHeading,.wtQdrW_documentHeading,.wtQdrW_issueList div{justify-content:space-between;gap:10px}.wtQdrW_eyebrow{color:var(--dsw-alias-state-business-primary);letter-spacing:.05em;font-size:.857rem;font-weight:700}.wtQdrW_evidenceBadge,.wtQdrW_statusLine span,.wtQdrW_documentMeta span,.wtQdrW_issueList div span{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;padding:3px 7px;font-size:.786rem;line-height:14px}.wtQdrW_evidenceBadge[data-level=high]{color:var(--dsw-alias-state-success-primary,#4e9962)}.wtQdrW_evidenceBadge[data-level=low],.wtQdrW_evidenceBadge[data-level=unknown]{color:var(--dsw-alias-state-warning-primary,#b07a2e)}.wtQdrW_header h2{margin:10px 0 3px;font-size:1.357rem;line-height:24px}.wtQdrW_absolutePath{overflow-wrap:anywhere;color:var(--dsw-alias-label-secondary);margin:0;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:.857rem;line-height:16px}.wtQdrW_statusLine{flex-wrap:wrap;gap:5px;margin-top:10px}.wtQdrW_section{border-bottom:1px solid var(--dsw-alias-border-l2);padding:15px 18px}.wtQdrW_section h3,.wtQdrW_sectionHeading h3{margin:0 0 10px;font-size:1rem;font-weight:650}.wtQdrW_sectionHeading h3{margin:0}.wtQdrW_sectionHeading>span{color:var(--dsw-alias-label-tertiary);font-size:.857rem}.wtQdrW_field{gap:5px;display:grid}.wtQdrW_field>span,.wtQdrW_summaryBox>span{color:var(--dsw-alias-label-secondary);font-size:.857rem;font-weight:600}.wtQdrW_field input,.wtQdrW_documentHeading select{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-bg-layer-1);font:inherit;border-radius:8px;font-size:.929rem}.wtQdrW_field input{width:100%;min-height:34px;padding:6px 9px}.wtQdrW_field input:focus-visible,.wtQdrW_documentHeading select:focus-visible,.wtQdrW_primaryButton:focus-visible,.wtQdrW_secondaryButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}.wtQdrW_sourceLine{color:var(--dsw-alias-label-tertiary);grid-template-columns:auto minmax(0,1fr);gap:8px;margin:7px 0 0;font-size:.786rem;display:grid}.wtQdrW_sourceLine code{color:inherit;text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;overflow:hidden}.wtQdrW_summaryBox{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 68%, transparent);border-radius:9px;margin-top:13px;padding:10px}.wtQdrW_summaryBox p{color:var(--dsw-alias-label-secondary);margin:5px 0 0;font-size:.929rem;line-height:17px}.wtQdrW_evidenceList,.wtQdrW_issueList,.wtQdrW_documentList{gap:7px;margin:10px 0 0;padding:0;list-style:none;display:grid}.wtQdrW_evidenceList li{color:var(--dsw-alias-label-secondary);padding-left:12px;font-size:.857rem;line-height:16px}.wtQdrW_evidenceList li:before{width:12px;color:var(--dsw-alias-state-business-primary);content:\"•\";margin-left:-12px;display:inline-block}.wtQdrW_issueList li{border:1px solid var(--dsw-alias-border-l2);border-left-width:3px;border-radius:8px;padding:9px}.wtQdrW_issueList li[data-severity=blocking],.wtQdrW_issueList li[data-severity=error]{border-left-color:var(--dsw-alias-state-error-primary,#bf5252)}.wtQdrW_issueList li[data-severity=warning]{border-left-color:var(--dsw-alias-state-warning-primary,#b07a2e)}.wtQdrW_issueList strong{font-size:.857rem}.wtQdrW_issueList p{color:var(--dsw-alias-label-secondary);margin:5px 0 0;font-size:.857rem;line-height:16px}.wtQdrW_issueList code{overflow-wrap:anywhere;color:var(--dsw-alias-label-tertiary);margin-top:5px;font-size:.786rem;display:block}.wtQdrW_documentCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 58%, transparent);border-radius:10px;min-width:0;padding:10px}.wtQdrW_documentHeading>div{min-width:0}.wtQdrW_documentHeading strong,.wtQdrW_documentHeading code{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.wtQdrW_documentHeading strong{font-size:.929rem}.wtQdrW_documentHeading code{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:.786rem}.wtQdrW_documentHeading select{max-width:118px;min-height:30px;padding:4px 7px}.wtQdrW_lockedBinding{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 24%, transparent);max-width:138px;color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, transparent);text-align:center;border-radius:999px;padding:5px 8px;font-size:.786rem;line-height:14px}.wtQdrW_documentMeta{flex-wrap:wrap;gap:4px;margin-top:8px}.wtQdrW_preview{max-height:130px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-bg-layer-1);white-space:pre-wrap;overflow-wrap:anywhere;border-radius:7px;margin:8px 0 0;padding:8px;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:.786rem;line-height:15px;overflow:auto}.wtQdrW_emptyCopy{color:var(--dsw-alias-label-tertiary);margin:10px 0 0;font-size:.857rem}.wtQdrW_actions{gap:9px;margin-top:auto;padding:16px 18px 20px;display:grid}.wtQdrW_impactNote{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 24%, transparent);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 6%, transparent);border-radius:9px;gap:3px;padding:10px;display:grid}.wtQdrW_impactNote strong{font-size:.857rem}.wtQdrW_impactNote span{color:var(--dsw-alias-label-secondary);font-size:.786rem;line-height:15px}.wtQdrW_primaryButton,.wtQdrW_secondaryButton{min-height:34px;font:inherit;cursor:pointer;border:1px solid #0000;border-radius:8px;padding:7px 12px;font-size:.929rem;font-weight:600}.wtQdrW_primaryButton{color:var(--dsw-alias-label-on-color,#fff);background:var(--dsw-alias-state-business-primary)}.wtQdrW_primaryButton:disabled{opacity:.48;cursor:default}.wtQdrW_secondaryButton{color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);margin-top:10px}.wtQdrW_validation,.wtQdrW_submitError,.wtQdrW_submitStatus{margin:0;font-size:.857rem;line-height:16px}.wtQdrW_validation,.wtQdrW_submitError{color:var(--dsw-alias-state-error-primary,#bf5252)}.wtQdrW_submitStatus{color:var(--dsw-alias-state-success-primary,#4e9962)}.wtQdrW_message{text-align:center;place-content:center;min-height:260px;padding:24px;display:grid}.wtQdrW_message h2{margin:0;font-size:1.143rem}.wtQdrW_message p{max-width:280px;color:var(--dsw-alias-label-secondary);margin:7px 0 0;font-size:.929rem;line-height:18px}.wtQdrW_visuallyHidden{clip:rect(0 0 0 0);clip-path:inset(50%);white-space:nowrap;width:1px;height:1px;position:absolute;overflow:hidden}.wtQdrW_sectionHeadingTools{align-items:center;gap:8px;display:flex}.wtQdrW_autoResolveButton{border:1px solid color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 45%, transparent);color:var(--dsw-alias-state-warning-primary,#b07a2e);font:inherit;cursor:pointer;background:0 0;border-radius:999px;padding:4px 9px;font-size:.857rem;font-weight:600}.wtQdrW_autoResolveButton:hover{background:color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 10%, transparent)}.wtQdrW_documentCard.wtQdrW_roleConflict{border-left:3px solid var(--dsw-alias-state-warning-primary,#b07a2e)}.wtQdrW_conflictBadge{color:var(--dsw-alias-state-warning-primary,#b07a2e);background:color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 12%, transparent);border-radius:999px;flex:none;padding:3px 7px;font-size:.786rem;line-height:14px}.wtQdrW_conflictBadge[data-kind=primary]{color:var(--dsw-alias-state-success-primary,#4e9962);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#4e9962) 12%, transparent)}@media (width<=420px){.wtQdrW_header,.wtQdrW_section,.wtQdrW_actions{padding-left:12px;padding-right:12px}.wtQdrW_documentHeading{flex-direction:column;align-items:stretch}.wtQdrW_documentHeading select{width:100%;max-width:none}.wtQdrW_lockedBinding{max-width:none}}";
		...
		var CandidateDetails_module_css_default = {
			"absolutePath": "wtQdrW_absolutePath",
			"actions": "wtQdrW_actions",
			"autoResolveButton": "wtQdrW_autoResolveButton",
			"conflictBadge": "wtQdrW_conflictBadge",
			"details": "wtQdrW_details",
			"documentCard": "wtQdrW_documentCard",
			"documentHeading": "wtQdrW_documentHeading",
			"documentList": "wtQdrW_documentList",
			"documentMeta": "wtQdrW_documentMeta",
			"emptyCopy": "wtQdrW_emptyCopy",
			"evidenceBadge": "wtQdrW_evidenceBadge",
			"evidenceList": "wtQdrW_evidenceList",
			"eyebrow": "wtQdrW_eyebrow",
			"field": "wtQdrW_field",
			"header": "wtQdrW_header",
			"headerRow": "wtQdrW_headerRow",
			"impactNote": "wtQdrW_impactNote",
			"issueList": "wtQdrW_issueList",
			"lockedBinding": "wtQdrW_lockedBinding",
			"message": "wtQdrW_message",
			"preview": "wtQdrW_preview",
			"primaryButton": "wtQdrW_primaryButton",
			"roleConflict": "wtQdrW_roleConflict",
			"secondaryButton": "wtQdrW_secondaryButton",
			"section": "wtQdrW_section",
			"sectionHeading": "wtQdrW_sectionHeading",
			"sectionHeadingTools": "wtQdrW_sectionHeadingTools",
			"sourceLine": "wtQdrW_sourceLine",
			"statusLine": "wtQdrW_statusLine",
			"submitError": "wtQdrW_submitError",
			"submitStatus": "wtQdrW_submitStatus",
			"summaryBox": "wtQdrW_summaryBox",
			"validation": "wtQdrW_validation",
			"visuallyHidden": "wtQdrW_visuallyHidden"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:D:\Deepseek Harness Personal\plugins\project-control\src\client\ProjectConsole.module.css.mjs
		const css$1 = ".IG5C-W_console{width:100%;min-height:0;color:var(--dsw-alias-label-primary);flex-direction:column;gap:10px;display:flex}.IG5C-W_header{border-bottom:1px solid var(--dsw-alias-border-l2);justify-content:space-between;align-items:flex-start;gap:12px;padding-bottom:10px;display:flex}.IG5C-W_headerMain{flex-direction:column;gap:4px;min-width:0;display:flex}.IG5C-W_headerMain h2{margin:0;font-size:17px;line-height:24px}.IG5C-W_projectId{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin:0;font-size:12px;overflow:hidden}.IG5C-W_headerActions{flex:none;gap:8px;display:flex}.IG5C-W_backButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);font:inherit;cursor:pointer;background:0 0;border-radius:8px;align-self:flex-start;padding:2px 8px;font-size:12px}.IG5C-W_backButton:hover{color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l3)}.IG5C-W_smallButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 5%, transparent);font:inherit;cursor:pointer;border-radius:8px;padding:4px 10px;font-size:12px}.IG5C-W_smallButton:hover:not(:disabled){border-color:var(--dsw-alias-border-l3)}.IG5C-W_smallButton:disabled{opacity:.45;cursor:not-allowed}.IG5C-W_smallButton[data-pinned=true]{border-color:var(--dsw-alias-state-business-primary)}.IG5C-W_confirmButton{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 45%, transparent);color:#fff;background:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;border-radius:8px;padding:4px 12px;font-size:12px;font-weight:650}.IG5C-W_confirmButton:hover:not(:disabled){filter:brightness(1.08)}.IG5C-W_confirmButton:disabled{opacity:.45;cursor:not-allowed}.IG5C-W_iconButton{border:1px solid var(--dsw-alias-border-l2);width:30px;height:30px;color:var(--dsw-alias-label-secondary);cursor:pointer;background:0 0;border-radius:8px;place-items:center;font-size:15px;display:grid}.IG5C-W_iconButton:hover{color:var(--dsw-alias-label-primary);border-color:var(--dsw-alias-border-l3)}.IG5C-W_tabs{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;gap:4px;display:flex;overflow-x:auto}.IG5C-W_tab{color:var(--dsw-alias-label-secondary);font:inherit;white-space:nowrap;cursor:pointer;background:0 0;border:0;border-bottom:2px solid #0000;align-items:center;gap:6px;padding:8px 14px;font-size:13px;display:flex;position:relative}.IG5C-W_tab:hover{color:var(--dsw-alias-label-primary)}.IG5C-W_tab[aria-selected=true]{color:var(--dsw-alias-label-primary);border-bottom-color:var(--dsw-alias-state-business-primary);font-weight:650}.IG5C-W_countBadge{color:var(--dsw-alias-label-secondary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);border-radius:999px;padding:0 6px;font-size:11px}.IG5C-W_tabPanel{min-height:0;overflow:auto}.IG5C-W_errorBanner{border:1px solid color-mix(in srgb, var(--dsw-alias-state-danger-primary,#e5484d) 45%, transparent);color:var(--dsw-alias-state-danger-primary,#e5484d);border-radius:8px;justify-content:space-between;align-items:center;gap:10px;padding:8px 12px;font-size:12px;display:flex}.IG5C-W_tabNotice{color:var(--dsw-alias-label-tertiary);text-align:center;padding:28px 16px;font-size:13px}.IG5C-W_emptyCopy{color:var(--dsw-alias-label-tertiary);margin:4px 0;font-size:12px}.IG5C-W_overview{flex-direction:column;gap:14px;display:flex}.IG5C-W_statGrid{grid-template-columns:repeat(auto-fit,minmax(140px,1fr));gap:10px;display:grid}.IG5C-W_statCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 4%, transparent);border-radius:10px;flex-direction:column;gap:2px;padding:12px;display:flex}.IG5C-W_statCard strong{font-size:22px;line-height:28px}.IG5C-W_statCard span{color:var(--dsw-alias-label-secondary);font-size:12px}.IG5C-W_statCard small{color:var(--dsw-alias-label-tertiary);font-size:11px}.IG5C-W_overviewFacts{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;flex-direction:column;gap:8px;padding:12px;display:flex}.IG5C-W_overviewFacts h3{margin:0;font-size:13px}.IG5C-W_overviewFacts dl{flex-direction:column;gap:4px;margin:0;font-size:12px;display:flex}.IG5C-W_overviewFacts dl>div{gap:10px;display:flex}.IG5C-W_overviewFacts dt{color:var(--dsw-alias-label-tertiary);min-width:72px}.IG5C-W_overviewFacts dd{margin:0}.IG5C-W_sectionBar{justify-content:space-between;align-items:center;gap:10px;margin-bottom:10px;display:flex}.IG5C-W_sectionBar h3{margin:0;font-size:14px}.IG5C-W_itemList{flex-direction:column;gap:8px;margin:0;padding:0;list-style:none;display:flex}.IG5C-W_itemCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 3%, transparent);border-radius:10px;flex-direction:column;gap:8px;padding:10px 12px;display:flex}.IG5C-W_itemMain{min-width:0;color:inherit;font:inherit;text-align:left;cursor:default;background:0 0;border:0;flex-direction:column;gap:4px;padding:0;display:flex}button.IG5C-W_itemMain{cursor:pointer}button.IG5C-W_itemMain:hover strong{text-decoration:underline}.IG5C-W_itemTopline{justify-content:space-between;align-items:center;gap:10px;min-width:0;display:flex}.IG5C-W_itemTopline strong{text-overflow:ellipsis;white-space:nowrap;font-size:13px;overflow:hidden}.IG5C-W_priorityBadge{color:var(--dsw-alias-label-secondary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);border-radius:999px;flex:none;padding:1px 7px;font-size:11px}.IG5C-W_itemInstruction{color:var(--dsw-alias-label-secondary);margin:0;font-size:12px}.IG5C-W_acceptanceList{color:var(--dsw-alias-label-secondary);margin:2px 0 0;padding-left:16px;font-size:12px}.IG5C-W_itemMeta{color:var(--dsw-alias-label-tertiary);flex-wrap:wrap;align-items:center;gap:10px;font-size:11px;display:flex}.IG5C-W_itemActions{flex-wrap:wrap;gap:8px;display:flex}.IG5C-W_statusBadge{border:1px solid var(--dsw-alias-border-l2);border-radius:999px;padding:1px 8px;font-size:11px}.IG5C-W_statusBadge[data-value=running],.IG5C-W_statusBadge[data-value=pending],.IG5C-W_statusBadge[data-value=requested],.IG5C-W_statusBadge[data-value=in_review]{color:var(--dsw-alias-state-business-primary);border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 40%, transparent)}.IG5C-W_statusBadge[data-value=blocked],.IG5C-W_statusBadge[data-value=failed],.IG5C-W_statusBadge[data-value=rejected]{color:var(--dsw-alias-state-danger-primary,#e5484d);border-color:color-mix(in srgb, var(--dsw-alias-state-danger-primary,#e5484d) 40%, transparent)}.IG5C-W_statusBadge[data-value=completed],.IG5C-W_statusBadge[data-value=approved]{color:var(--dsw-alias-state-success-primary,#46a758);border-color:color-mix(in srgb, var(--dsw-alias-state-success-primary,#46a758) 40%, transparent)}.IG5C-W_createItemForm{border:1px solid var(--dsw-alias-border-l2);border-radius:10px;flex-direction:column;gap:8px;margin-bottom:12px;padding:12px;display:flex}.IG5C-W_createItemForm label{color:var(--dsw-alias-label-secondary);flex-direction:column;gap:4px;font-size:12px;display:flex}.IG5C-W_createItemForm input,.IG5C-W_createItemForm textarea,.IG5C-W_reviewDecide textarea{box-sizing:border-box;border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-background-panel,transparent);font:inherit;border-radius:8px;padding:6px 8px;font-size:12px}.IG5C-W_formActions{flex-wrap:wrap;gap:8px;display:flex}.IG5C-W_reviewDetail{border-top:1px dashed var(--dsw-alias-border-l2);flex-direction:column;gap:10px;padding-top:8px;display:flex}.IG5C-W_actionList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.IG5C-W_actionList li{align-items:baseline;gap:8px;font-size:12px;display:flex}.IG5C-W_actionList li strong{flex:none;min-width:56px}.IG5C-W_actionList li small{color:var(--dsw-alias-label-tertiary);margin-left:auto}.IG5C-W_reviewDecide{flex-direction:column;gap:8px;display:flex}.IG5C-W_reviewDecide textarea{resize:vertical;width:100%}.IG5C-W_updateList{flex-direction:column;gap:6px;margin:0;padding:0;list-style:none;display:flex}.IG5C-W_updateList>li{border:1px solid var(--dsw-alias-border-l2);border-radius:8px;overflow:hidden}.IG5C-W_updateMain{box-sizing:border-box;width:100%;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;flex-direction:column;gap:4px;padding:8px 10px;display:flex}.IG5C-W_updateMain:hover{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 5%, transparent)}.IG5C-W_updateKindBadge{background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);border-radius:999px;padding:1px 7px;font-size:11px}.IG5C-W_updateKindBadge[data-kind=blocker]{color:var(--dsw-alias-state-danger-primary,#e5484d)}.IG5C-W_updateKindBadge[data-kind=completion_declared]{color:var(--dsw-alias-state-success-primary,#46a758)}.IG5C-W_eventList{flex-direction:column;gap:4px;margin:8px 0 0;padding:0;list-style:none;display:flex}.IG5C-W_eventList>li{border-bottom:1px solid var(--dsw-alias-border-l2);align-items:flex-start;gap:10px;padding:6px 0;display:flex}.IG5C-W_eventDot{background:var(--dsw-alias-state-business-primary);border-radius:999px;flex:none;width:7px;height:7px;margin-top:5px}.IG5C-W_eventMain{flex-direction:column;gap:2px;min-width:0;display:flex}.IG5C-W_eventMain strong{font-size:12px}.IG5C-W_eventAggregate{color:var(--dsw-alias-label-tertiary);font-size:11px}.IG5C-W_eventData{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:11px;display:block;overflow:hidden}.IG5C-W_eventTime{color:var(--dsw-alias-label-tertiary);flex:none;margin-left:auto;font-size:11px}.IG5C-W_documentPath{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;font-size:12px;overflow:hidden}.IG5C-W_followBanner{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 35%, transparent);color:var(--dsw-alias-state-business-primary);border-radius:8px;padding:8px 12px;font-size:12px}.IG5C-W_currentBadge{color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 12%, transparent);border-radius:999px;padding:1px 7px;font-size:11px}.IG5C-W_itemCard[data-current-session=true]{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 45%, transparent)}";
		...
		var ProjectConsole_module_css_default = {
			"acceptanceList": "IG5C-W_acceptanceList",
			"actionList": "IG5C-W_actionList",
			"backButton": "IG5C-W_backButton",
			"confirmButton": "IG5C-W_confirmButton",
			"console": "IG5C-W_console",
			"countBadge": "IG5C-W_countBadge",
			"createItemForm": "IG5C-W_createItemForm",
			"currentBadge": "IG5C-W_currentBadge",
			"documentPath": "IG5C-W_documentPath",
			"emptyCopy": "IG5C-W_emptyCopy",
			"errorBanner": "IG5C-W_errorBanner",
			"eventAggregate": "IG5C-W_eventAggregate",
			"eventData": "IG5C-W_eventData",
			"eventDot": "IG5C-W_eventDot",
			"eventList": "IG5C-W_eventList",
			"eventMain": "IG5C-W_eventMain",
			"eventTime": "IG5C-W_eventTime",
			"followBanner": "IG5C-W_followBanner",
			"formActions": "IG5C-W_formActions",
			"header": "IG5C-W_header",
			"headerActions": "IG5C-W_headerActions",
			"headerMain": "IG5C-W_headerMain",
			"iconButton": "IG5C-W_iconButton",
			"itemActions": "IG5C-W_itemActions",
			"itemCard": "IG5C-W_itemCard",
			"itemInstruction": "IG5C-W_itemInstruction",
			"itemList": "IG5C-W_itemList",
			"itemMain": "IG5C-W_itemMain",
			"itemMeta": "IG5C-W_itemMeta",
			"itemTopline": "IG5C-W_itemTopline",
			"overview": "IG5C-W_overview",
			"overviewFacts": "IG5C-W_overviewFacts",
			"priorityBadge": "IG5C-W_priorityBadge",
			"projectId": "IG5C-W_projectId",
			"reviewDecide": "IG5C-W_reviewDecide",
			"reviewDetail": "IG5C-W_reviewDetail",
			"sectionBar": "IG5C-W_sectionBar",
			"smallButton": "IG5C-W_smallButton",
			"statCard": "IG5C-W_statCard",
			"statGrid": "IG5C-W_statGrid",
			"statusBadge": "IG5C-W_statusBadge",
			"tab": "IG5C-W_tab",
			"tabNotice": "IG5C-W_tabNotice",
			"tabPanel": "IG5C-W_tabPanel",
			"tabs": "IG5C-W_tabs",
			"updateKindBadge": "IG5C-W_updateKindBadge",
			"updateList": "IG5C-W_updateList",
			"updateMain": "IG5C-W_updateMain"
		};
		//#endregion
		...
		//#endregion
		//#region \0dsh-css:D:\Deepseek Harness Personal\plugins\project-control\src\client\ProjectControlPlaceholder.module.css.mjs
		const css = ".bwCm7G_console{box-sizing:border-box;width:100%;height:100%;min-height:0;color:var(--dsw-alias-label-primary);background:radial-gradient(circle at 100% 0, color-mix(in srgb, var(--dsw-alias-state-business-primary) 7%, transparent), transparent 36%);flex-direction:column;display:flex;overflow:hidden}.bwCm7G_consoleHeader{border-bottom:1px solid var(--dsw-alias-border-l2);flex:none;justify-content:space-between;align-items:center;gap:10px;padding:14px 14px 12px;display:flex}.bwCm7G_consoleHeader>div{min-width:0}.bwCm7G_consoleHeader h1{margin:6px 0 0;font-size:17px;line-height:24px}.bwCm7G_consoleHeader p{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;margin:2px 0 0;font-size:12px;overflow:hidden}.bwCm7G_gateBadge{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 24%, transparent);color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 8%, transparent);letter-spacing:.04em;border-radius:999px;padding:2px 7px;font-size:12px;font-weight:650;display:inline-block}.bwCm7G_iconButton{border:1px solid var(--dsw-alias-border-l2);width:30px;height:30px;color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;cursor:pointer;border-radius:8px;flex:none;place-items:center;padding:0;display:grid}.bwCm7G_content{flex:1;min-width:0;min-height:0;padding:12px 14px 16px;overflow:auto}.bwCm7G_readyState{gap:13px;min-width:0;display:grid}.bwCm7G_statusCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 72%, transparent);border-radius:11px;grid-template-columns:34px minmax(0,1fr) auto;align-items:center;gap:9px;padding:10px;display:grid}.bwCm7G_statusIcon{width:32px;height:32px;color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent);border-radius:9px;place-items:center;display:grid}.bwCm7G_statusIcon svg,.bwCm7G_emptyIcon svg{fill:none;stroke:currentColor;stroke-linecap:round;stroke-linejoin:round;stroke-width:1.5px;width:19px;height:19px}.bwCm7G_statusCard h2{margin:0;font-size:14px;line-height:24px}.bwCm7G_statusCard p{color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:12px;line-height:17px}.bwCm7G_countBadge{color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);white-space:nowrap;border-radius:999px;padding:3px 7px;font-size:12px}.bwCm7G_intakeSection,.bwCm7G_candidateSection,.bwCm7G_projectSection{min-width:0}.bwCm7G_sectionHeading{justify-content:space-between;align-items:flex-end;gap:8px;margin-bottom:7px;display:flex}.bwCm7G_sectionHeading h2{color:var(--dsw-alias-label-secondary);margin:0;font-size:14px;font-weight:650}.bwCm7G_sectionHeading p{color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:12px;line-height:17px}.bwCm7G_sectionHeading>span{color:var(--dsw-alias-label-tertiary);flex:none;font-size:12px}.bwCm7G_actionGrid{grid-template-columns:repeat(2,minmax(0,1fr));gap:6px;display:grid}.bwCm7G_primaryAction{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 22%, var(--dsw-alias-border-l2));min-width:0;min-height:52px;color:var(--dsw-alias-label-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 5%, var(--dsw-alias-bg-layer-2));font:inherit;text-align:left;cursor:pointer;border-radius:10px;grid-template-columns:25px minmax(0,1fr);align-items:center;gap:7px;padding:8px;display:grid}.bwCm7G_primaryAction>span:first-child{width:24px;height:24px;color:var(--dsw-alias-state-business-primary);background:color-mix(in srgb, var(--dsw-alias-state-business-primary) 10%, transparent);border-radius:7px;place-items:center;font-size:17px;display:grid}.bwCm7G_primaryAction strong,.bwCm7G_primaryAction small{text-overflow:ellipsis;display:block;overflow:hidden}.bwCm7G_primaryAction strong{white-space:nowrap;font-size:13px}.bwCm7G_primaryAction small{color:var(--dsw-alias-label-tertiary);margin-top:2px;font-size:14px;line-height:15px}.bwCm7G_primaryAction:hover:not(:disabled),.bwCm7G_candidateCard:hover{border-color:color-mix(in srgb, var(--dsw-alias-state-business-primary) 45%, transparent)}.bwCm7G_primaryAction:disabled,.bwCm7G_ignoreButton:disabled{opacity:.45;cursor:default}.bwCm7G_bridgeNotice,.bwCm7G_scanNotice,.bwCm7G_scanError,.bwCm7G_emptyCopy{color:var(--dsw-alias-label-tertiary);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 62%, transparent);border-radius:8px;margin:7px 0 0;padding:8px 9px;font-size:12px;line-height:17px}.bwCm7G_bridgeNotice,.bwCm7G_scanError{border:1px solid color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 28%, transparent)}.bwCm7G_scanNotice,.bwCm7G_scanError{gap:2px;display:grid}.bwCm7G_scanNotice strong,.bwCm7G_scanError strong{color:var(--dsw-alias-label-secondary);font-size:12px}.bwCm7G_scanNotice span,.bwCm7G_scanError span{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;overflow:hidden}.bwCm7G_candidateList,.bwCm7G_projectList{gap:6px;margin:0;padding:0;list-style:none;display:grid}.bwCm7G_candidateCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 62%, transparent);border-radius:10px;grid-template-columns:minmax(0,1fr) auto;min-width:0;transition:border-color .12s;display:grid}.bwCm7G_candidateCard[data-ignored=true]{opacity:.68}.bwCm7G_candidateMain{min-width:0;color:inherit;font:inherit;text-align:left;cursor:pointer;background:0 0;border:0;gap:4px;padding:9px;display:grid}.bwCm7G_candidateTopline,.bwCm7G_candidateMeta{align-items:center;gap:5px;min-width:0;display:flex}.bwCm7G_candidateTopline{justify-content:space-between}.bwCm7G_candidateTopline strong{text-overflow:ellipsis;white-space:nowrap;font-size:14px;font-weight:600;overflow:hidden}.bwCm7G_candidateTopline>span,.bwCm7G_candidateMeta>span{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);border-radius:999px;flex:none;padding:2px 6px;font-size:14px}.bwCm7G_candidateTopline>span[data-level=high]{color:var(--dsw-alias-state-success-primary,#4e9962)}.bwCm7G_candidateTopline>span[data-level=low],.bwCm7G_candidateTopline>span[data-level=unknown]{color:var(--dsw-alias-state-warning-primary,#b07a2e)}.bwCm7G_candidatePath{color:var(--dsw-alias-label-tertiary);text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px;overflow:hidden}.bwCm7G_candidateMeta{flex-wrap:wrap}.bwCm7G_ignoreButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;cursor:pointer;border-radius:7px;align-self:center;margin-right:8px;padding:4px 7px;font-size:14px}.bwCm7G_projectItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 62%, transparent);border-radius:9px;justify-content:space-between;align-items:center;gap:8px;min-width:0;padding:8px 9px;display:flex}.bwCm7G_projectItem div{min-width:0}.bwCm7G_projectItem strong,.bwCm7G_projectItem small{text-overflow:ellipsis;white-space:nowrap;display:block;overflow:hidden}.bwCm7G_projectItem strong{font-size:13px;font-weight:550}.bwCm7G_projectItem small,.bwCm7G_projectItem>span{color:var(--dsw-alias-label-tertiary);font-size:14px}.bwCm7G_projectItem>span{flex:none}.bwCm7G_createSection{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 48%, transparent);border-radius:11px;min-width:0;padding:9px}.bwCm7G_createForm{gap:7px;min-width:0;display:grid}.bwCm7G_createField{gap:3px;min-width:0;display:grid}.bwCm7G_fieldLabel{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:600}.bwCm7G_parentRow{grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:6px;min-width:0;display:grid}.bwCm7G_pathText{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);text-overflow:ellipsis;white-space:nowrap;border-radius:8px;padding:6px 8px;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px;overflow:hidden}.bwCm7G_textInput,.bwCm7G_selectInput{border:1px solid var(--dsw-alias-border-l2);min-width:0;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;border-radius:8px;padding:6px 8px;font-size:13px}.bwCm7G_textInput:disabled,.bwCm7G_selectInput:disabled{opacity:.55}.bwCm7G_templateDescription{color:var(--dsw-alias-label-tertiary);margin:0;font-size:14px;line-height:24px}.bwCm7G_createActions{flex-wrap:wrap;justify-content:flex-end;gap:6px;margin-top:3px;display:flex}.bwCm7G_confirmButton{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 34%, transparent);color:#fff;background:var(--dsw-alias-state-business-primary);font:inherit;cursor:pointer;border-radius:8px;padding:6px 12px;font-size:13px}.bwCm7G_confirmButton:disabled{opacity:.5;cursor:default}.bwCm7G_smallButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-secondary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;cursor:pointer;border-radius:7px;flex:none;padding:5px 8px;font-size:14px}.bwCm7G_previewCard{border:1px solid var(--dsw-alias-border-l2);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 58%, transparent);border-radius:9px;gap:6px;min-width:0;padding:8px;display:grid}.bwCm7G_previewTopline{justify-content:space-between;align-items:center;gap:6px;min-width:0;display:flex}.bwCm7G_previewTopline strong{font-size:13px}.bwCm7G_previewTopline span{color:var(--dsw-alias-label-tertiary);flex:none;font-size:14px}.bwCm7G_previewFacts{gap:3px;margin:0;display:grid}.bwCm7G_previewFacts div{grid-template-columns:64px minmax(0,1fr);gap:6px;min-width:0;display:grid}.bwCm7G_previewFacts dt{color:var(--dsw-alias-label-tertiary);font-size:14px}.bwCm7G_previewFacts dd{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin:0;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px;overflow:hidden}.bwCm7G_previewNote{color:var(--dsw-alias-label-tertiary);margin:0;font-size:14px;line-height:24px}.bwCm7G_operationList{gap:2px;max-height:148px;margin:0;padding:0;list-style:none;display:grid;overflow:auto}.bwCm7G_operationItem{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 46%, transparent);border-radius:6px;grid-template-columns:16px minmax(0,1fr) auto;align-items:center;gap:5px;min-width:0;padding:3px 6px;font-size:14px;display:grid}.bwCm7G_operationPath{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;overflow:hidden}.bwCm7G_hashText{color:var(--dsw-alias-label-tertiary);font-family:ui-monospace,Cascadia Mono,Consolas,monospace}.bwCm7G_createSuccess,.bwCm7G_createError{border-radius:8px;gap:6px;margin-top:2px;padding:8px;font-size:12px;line-height:17px;display:grid}.bwCm7G_createSuccess{border:1px solid color-mix(in srgb, var(--dsw-alias-state-success-primary,#4e9962) 30%, transparent);color:var(--dsw-alias-state-success-primary,#4e9962);background:color-mix(in srgb, var(--dsw-alias-state-success-primary,#4e9962) 8%, transparent)}.bwCm7G_createError{border:1px solid color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 28%, transparent);color:var(--dsw-alias-label-secondary);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 62%, transparent)}.bwCm7G_statusFacts{grid-template-columns:repeat(3,minmax(0,1fr));gap:5px;margin:0;display:grid}.bwCm7G_statusFacts div{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 58%, transparent);border-radius:8px;min-width:0;padding:7px}.bwCm7G_statusFacts dt{color:var(--dsw-alias-label-tertiary);font-size:14px}.bwCm7G_statusFacts dd{color:var(--dsw-alias-label-secondary);text-overflow:ellipsis;white-space:nowrap;margin:2px 0 0;font-size:12px;overflow:hidden}.bwCm7G_statePanel{text-align:center;flex-direction:column;justify-content:center;align-items:center;min-height:260px;display:flex}.bwCm7G_emptyIcon{border:1px solid var(--dsw-alias-border-l2);width:44px;height:44px;color:var(--dsw-alias-label-tertiary);border-radius:14px;place-items:center;margin-bottom:10px;display:grid}.bwCm7G_statePanel h2{margin:0;font-size:13px}.bwCm7G_statePanel p{max-width:260px;color:var(--dsw-alias-label-secondary);margin:6px 0 0;font-size:13px;line-height:24px}.bwCm7G_secondaryButton{border:1px solid var(--dsw-alias-border-l2);color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;cursor:pointer;border-radius:8px;margin-top:11px;padding:6px 12px;font-size:13px}.bwCm7G_projectItemActions{flex:none;align-items:center;gap:6px;display:flex}.bwCm7G_documentPanel{border:1px solid color-mix(in srgb, var(--dsw-alias-state-business-primary) 16%, var(--dsw-alias-border-l2));background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 48%, transparent);border-radius:11px;min-width:0;padding:9px}.bwCm7G_documentPanelHeader{justify-content:space-between;align-items:flex-start;gap:8px;min-width:0;display:flex}.bwCm7G_documentPanelHeader>div:first-child{min-width:0}.bwCm7G_documentPanelHeader strong{font-size:13px}.bwCm7G_documentPanelHeader p{color:var(--dsw-alias-label-tertiary);margin:2px 0 0;font-size:14px}.bwCm7G_documentPanelActions{flex:none;gap:5px;display:flex}.bwCm7G_documentPanelEmpty{color:var(--dsw-alias-label-tertiary);margin:7px 0 0;font-size:12px;line-height:17px}.bwCm7G_documentLocation{font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px}.bwCm7G_documentList{gap:3px;max-height:190px;margin:7px 0 0;padding:0;list-style:none;display:grid;overflow:auto}.bwCm7G_documentRow{background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 46%, transparent);border-radius:7px;grid-template-columns:minmax(0,1fr) auto;align-items:center;gap:2px 8px;min-width:0;padding:5px 7px;display:grid}.bwCm7G_documentRowMain{grid-template-columns:auto minmax(0,1fr);align-items:center;gap:2px 7px;min-width:0;display:grid}.bwCm7G_documentRole{color:var(--dsw-alias-label-secondary);flex:none;font-size:12px;font-weight:600}.bwCm7G_documentPath,.bwCm7G_proposalPath{text-overflow:ellipsis;white-space:nowrap;font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px;overflow:hidden}.bwCm7G_documentRowSide{align-items:center;gap:5px;min-width:0;display:flex}.bwCm7G_documentStateBadge{color:var(--dsw-alias-label-tertiary);background:var(--dsw-alias-interactive-bg-hover);white-space:nowrap;border-radius:999px;padding:2px 6px;font-size:14px}.bwCm7G_documentStateBadge[data-state=ok]{color:var(--dsw-alias-state-success-primary,#4e9962)}.bwCm7G_documentStateBadge[data-state=changed],.bwCm7G_documentStateBadge[data-state=missing]{color:var(--dsw-alias-state-warning-primary,#b07a2e)}.bwCm7G_documentStateBadge[data-state=unreadable]{color:var(--dsw-alias-state-danger-primary,#c25555)}.bwCm7G_documentHash{color:var(--dsw-alias-label-tertiary);font-family:ui-monospace,Cascadia Mono,Consolas,monospace;font-size:14px}.bwCm7G_documentIssues{grid-column:1/-1;gap:2px;display:grid}.bwCm7G_documentIssue{color:var(--dsw-alias-label-tertiary);font-size:14px;line-height:17px}.bwCm7G_proposalGroup{gap:5px;margin-top:8px;display:grid}.bwCm7G_proposalGroupTitle{color:var(--dsw-alias-label-secondary);font-size:12px;font-weight:650}.bwCm7G_proposalCard{border:1px solid color-mix(in srgb, var(--dsw-alias-state-warning-primary,#b07a2e) 22%, transparent);background:color-mix(in srgb, var(--dsw-alias-bg-layer-2) 52%, transparent);border-radius:9px;gap:5px;min-width:0;padding:7px;display:grid}.bwCm7G_proposalLine,.bwCm7G_proposalActions{min-width:0;color:var(--dsw-alias-label-secondary);flex-wrap:wrap;align-items:center;gap:6px;font-size:12px;display:flex}.bwCm7G_proposalActions select{border:1px solid var(--dsw-alias-border-l2);min-width:0;max-width:100%;color:var(--dsw-alias-label-primary);background:var(--dsw-alias-interactive-bg-hover);font:inherit;border-radius:7px;padding:4px 6px;font-size:14px}.bwCm7G_proposalHint{color:var(--dsw-alias-label-tertiary);font-size:14px;line-height:17px}.bwCm7G_iconButton:focus-visible,.bwCm7G_primaryAction:focus-visible,.bwCm7G_candidateMain:focus-visible,.bwCm7G_ignoreButton:focus-visible,.bwCm7G_secondaryButton:focus-visible{outline:2px solid var(--dsw-alias-state-business-primary);outline-offset:2px}@media (width<=1180px){.bwCm7G_actionGrid,.bwCm7G_statusFacts{grid-template-columns:1fr}}@media (prefers-reduced-motion:reduce){.bwCm7G_candidateCard{transition:none}}";
		...
		var ProjectControlPlaceholder_module_css_default = {
			"actionGrid": "bwCm7G_actionGrid",
			"bridgeNotice": "bwCm7G_bridgeNotice",
			"candidateCard": "bwCm7G_candidateCard",
			"candidateList": "bwCm7G_candidateList",
			"candidateMain": "bwCm7G_candidateMain",
			"candidateMeta": "bwCm7G_candidateMeta",
			"candidatePath": "bwCm7G_candidatePath",
			"candidateSection": "bwCm7G_candidateSection",
			"candidateTopline": "bwCm7G_candidateTopline",
			"confirmButton": "bwCm7G_confirmButton",
			"console": "bwCm7G_console",
			"consoleHeader": "bwCm7G_consoleHeader",
			"content": "bwCm7G_content",
			"countBadge": "bwCm7G_countBadge",
			"createActions": "bwCm7G_createActions",
			"createError": "bwCm7G_createError",
			"createField": "bwCm7G_createField",
			"createForm": "bwCm7G_createForm",
			"createSection": "bwCm7G_createSection",
			"createSuccess": "bwCm7G_createSuccess",
			"documentHash": "bwCm7G_documentHash",
			"documentIssue": "bwCm7G_documentIssue",
			"documentIssues": "bwCm7G_documentIssues",
			"documentList": "bwCm7G_documentList",
			"documentLocation": "bwCm7G_documentLocation",
			"documentPanel": "bwCm7G_documentPanel",
			"documentPanelActions": "bwCm7G_documentPanelActions",
			"documentPanelEmpty": "bwCm7G_documentPanelEmpty",
			"documentPanelHeader": "bwCm7G_documentPanelHeader",
			"documentPath": "bwCm7G_documentPath",
			"documentRole": "bwCm7G_documentRole",
			"documentRow": "bwCm7G_documentRow",
			"documentRowMain": "bwCm7G_documentRowMain",
			"documentRowSide": "bwCm7G_documentRowSide",
			"documentStateBadge": "bwCm7G_documentStateBadge",
			"emptyCopy": "bwCm7G_emptyCopy",
			"emptyIcon": "bwCm7G_emptyIcon",
			"fieldLabel": "bwCm7G_fieldLabel",
			"gateBadge": "bwCm7G_gateBadge",
			"hashText": "bwCm7G_hashText",
			"iconButton": "bwCm7G_iconButton",
			"ignoreButton": "bwCm7G_ignoreButton",
			"intakeSection": "bwCm7G_intakeSection",
			"operationItem": "bwCm7G_operationItem",
			"operationList": "bwCm7G_operationList",
			"operationPath": "bwCm7G_operationPath",
			"parentRow": "bwCm7G_parentRow",
			"pathText": "bwCm7G_pathText",
			"previewCard": "bwCm7G_previewCard",
			"previewFacts": "bwCm7G_previewFacts",
			"previewNote": "bwCm7G_previewNote",
			"previewTopline": "bwCm7G_previewTopline",
			"primaryAction": "bwCm7G_primaryAction",
			"projectItem": "bwCm7G_projectItem",
			"projectItemActions": "bwCm7G_projectItemActions",
			"projectList": "bwCm7G_projectList",
			"projectSection": "bwCm7G_projectSection",
			"proposalActions": "bwCm7G_proposalActions",
			"proposalCard": "bwCm7G_proposalCard",
			"proposalGroup": "bwCm7G_proposalGroup",
			"proposalGroupTitle": "bwCm7G_proposalGroupTitle",
			"proposalHint": "bwCm7G_proposalHint",
			"proposalLine": "bwCm7G_proposalLine",
			"proposalPath": "bwCm7G_proposalPath",
			"readyState": "bwCm7G_readyState",
			"scanError": "bwCm7G_scanError",
			"scanNotice": "bwCm7G_scanNotice",
			"secondaryButton": "bwCm7G_secondaryButton",
			"sectionHeading": "bwCm7G_sectionHeading",
			"selectInput": "bwCm7G_selectInput",
			"smallButton": "bwCm7G_smallButton",
			"statePanel": "bwCm7G_statePanel",
			"statusCard": "bwCm7G_statusCard",
			"statusFacts": "bwCm7G_statusFacts",
			"statusIcon": "bwCm7G_statusIcon",
			"templateDescription": "bwCm7G_templateDescription",
			"textInput": "bwCm7G_textInput"
		};
		//#endregion
