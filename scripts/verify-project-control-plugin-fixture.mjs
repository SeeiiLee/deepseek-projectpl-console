...
const BASELINE_VERSION = '0.1.0-rc.15'
const CANDIDATE_VERSION = '0.1.0-rc.16'
...
async function main() {
  ...
  try {
    ...
    temporaryRoot = await mkdtemp(join(tmpdir(), 'dsh-project-control-rc16-managed-document-binding-acceptance-'))
    ...
    await writeJsonExclusive(receiptPath, {
      schemaVersion: 1,
      task: 'Project Control 0.1.0-rc.16 managed document binding hash acceptance isolated generation acceptance',
      startedAt,
